...
{
    { "nativeGetPagerStats", "(Lio/oracle/android/database/sqlite/SQLiteDebug$PagerStats;)V",
...
{
    jclass clazz;
    FIND_CLASS(clazz, "io/oracle/android/database/sqlite/SQLiteDebug$PagerStats");
    ...
    return jniRegisterNativeMethods(env, "io/oracle/android/database/sqlite/SQLiteDebug",
