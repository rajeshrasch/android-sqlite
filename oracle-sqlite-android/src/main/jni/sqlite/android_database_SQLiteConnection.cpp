...
{
    jclass clazz;
    FIND_CLASS(clazz, "io/oracle/android/database/sqlite/SQLiteCustomFunction");
    ...
    FIND_CLASS(clazz, "io/oracle/android/database/sqlite/SQLiteFunction");
    ...
    return jniRegisterNativeMethods(env,
        "io/oracle/android/database/sqlite/SQLiteConnection",
